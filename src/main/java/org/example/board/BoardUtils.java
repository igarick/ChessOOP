...
public class BoardUtils {
    public static List<Coordinates> getDiagonalCoordinatesBetween(Coordinates source,
                                                                  Coordinates target) {
    ...
    public static List<Coordinates> getVerticalCoordinatesBetween(Coordinates source,
                                                                  Coordinates target) {
// клетки лежат на одной вертикали
        ...
        for (int rank = source.rank + rankShift; rank != target.rank;
             rank += rankShift) {
    ...
    public static List<Coordinates> getHorizontalCoordinatesBetween(Coordinates source,
                                                                  Coordinates target) {
